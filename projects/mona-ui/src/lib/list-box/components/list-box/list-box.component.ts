...
@Component({
    ...
    standalone: true,
    imports: [ListViewComponent, ListViewSelectableDirective, ListViewItemTemplateDirective, NgIf, NgTemplateOutlet, ButtonDirective, FontAwesomeModule, ContainPipe]
})
