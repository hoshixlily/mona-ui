...
export class DropDownTreeDisableDirective<T> {
    ...
    public disableBy: InputSignal<string | Selector<T, any> | null | undefined> = input<
        string | Selector<T, any> | null | undefined
    >("");
    public disabledKeys: InputSignal<Iterable<any> | null | undefined> = input<Iterable<any> | null | undefined>([]);
    public options: InputSignal<Partial<DisableOptions> | ""> = input<Partial<DisableOptions> | "">("", {
