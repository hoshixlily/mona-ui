...
export class WindowResizeHandlerDirective implements AfterViewInit {
    ...
    public direction: InputSignal<WindowResizeHandlerDirection> = input.required<WindowResizeHandlerDirection>();
    ...
    public windowRef: InputSignal<WindowReference> = input.required<WindowReference>();
